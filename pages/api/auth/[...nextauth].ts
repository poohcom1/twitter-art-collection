...
if (AUTH_VER === "1.0" && (!appId || !appSecret)) {
    throw new Error("Missing TWITTER_API_KEY or TWITTER_API_SECRET env variables for Twitter OAuth1.0!")
}

if (AUTH_VER === "2.0" && (!clientId || !clientSecret)) {
    throw new Error("Missing TWITTER_CLIENT_ID or TWITTER_CLIENT_SECRET env variables for Twitter OAuth2.0!")
}
